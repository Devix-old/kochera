...
export async function generateMetadata() {
  return generateSiteMetadata({
    ...
    description: 'Entdecke alle unsere Rezeptkategorien: Hähnchen, Pasta, Vegetarisch, Kuchen, Pfannkuchen und vieles mehr. Über 100+ Rezepte in 18 Kategorien für alle Geschmäcker und Anlässe.',
    url: '/kategorien',
